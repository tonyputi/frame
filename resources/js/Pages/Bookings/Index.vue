    ...
    <app-layout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex my-4">
                    <search-input @input="filter" placeholder="Search for location or user" />
                    ...
                    <jet-table class="text-sm">
                        <template #header>
                            <tr class="bg-gray-800 text-white">
                                ...
                                <th class="px-2 py-4 text-left">Location</th>
                        ...
                        <template #body>
                            <tr v-for="resource in data" :key="resource.attributes.id" class="border border-black-600">
                                ...
                                <td class="px-2 py-4 text-left">
                                    <inertia-link class="text-black-500" :href="route('locations.show', resource.attributes.location.id)">
                                ...
                                <td class="px-2 py-4">
                                    <div class="inline-flex items-center">
                                        <button v-if="resource.permissions.canUpdate && resource.attributes.is_active"
                ...
                <div v-else class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    <p>Ooops! No Locations bookings to show. Please change search value </p>
                </div>
